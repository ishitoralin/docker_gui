const UrlList = {
    ...
    "getContainerDetail": { method: "GET", path: ["/api/docker/containers/", { key: "id" }, "/json"] },
    ...
    "getImageDetail": { method: "GET", path: ["/api/docker/images/", { key: "id" }, "/json"] },
    ...
    "postNetworkDisconnect": { method: "POST", path: ["/api/docker/networks/", { key: "id" }, "/disconnect"] },
    "postNetworkConnect": { method: "POST", path: ["/api/docker/networks/", { key: "id" }, "/connect"] },
